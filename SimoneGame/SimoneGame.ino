/*
 * Original Author: Denis Cosmin
 * Date: 19.09.2016
 * 
 * Updated Author: Lee Lerner at Uncorked Studios
...
Game::Game(int difficulty) : gameSpeed(700), lastButtonValue(-1), currentLevel(0), gameDifficulty(difficulty), gameIsOver(0) {
...
Game::Game() : gameSpeed(700), lastButtonValue(-1), currentLevel(0), gameDifficulty(10), gameIsOver(0) {
...
//added by Lee Lerner on 1/20/2018
int Game::gameOver() {
...
void Game::gameReset() {
    ...
    Game::lastButtonValue = -1;
    Game::gameSpeed = 1000;
    Game::currentLevel = 0;
    Game::gameDifficulty = 50;
    Game::gameIsOver = 0;
}
